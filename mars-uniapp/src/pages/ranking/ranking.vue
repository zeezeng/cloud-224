...
<template>
  <EphonePage title="主播排行" subtitle="每一份热爱都值得被看见">
    <PodiumBoard :records="rankingRecords" />
    <RankingList :records="rankingRecords.slice(3, 8)" value-label="" show-trend :start-rank="4" />
  </EphonePage>
</template>
