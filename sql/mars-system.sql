...
) ENGINE = InnoDB AUTO_INCREMENT = 76 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文件记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 254 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '登录日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_login_log` VALUES (240, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 16:41:10');
INSERT INTO `sys_login_log` VALUES (241, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 17:19:59');
INSERT INTO `sys_login_log` VALUES (242, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 18:45:17');
INSERT INTO `sys_login_log` VALUES (243, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 1, '密码错误', '2026-02-13 18:45:30');
INSERT INTO `sys_login_log` VALUES (244, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 1, '密码错误', '2026-02-13 18:45:37');
INSERT INTO `sys_login_log` VALUES (245, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 18:45:50');
INSERT INTO `sys_login_log` VALUES (246, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 1, '密码错误', '2026-02-13 19:39:57');
INSERT INTO `sys_login_log` VALUES (247, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 19:40:08');
INSERT INTO `sys_login_log` VALUES (248, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 19:51:26');
INSERT INTO `sys_login_log` VALUES (249, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 1, '密码错误', '2026-02-13 19:51:43');
INSERT INTO `sys_login_log` VALUES (250, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 1, '密码错误', '2026-02-13 19:52:02');
INSERT INTO `sys_login_log` VALUES (251, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 19:52:14');
INSERT INTO `sys_login_log` VALUES (252, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-13 20:12:43');
INSERT INTO `sys_login_log` VALUES (253, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10 or Windows Server 2016', 0, '登录成功', '2026-02-24 13:36:11');
...
CREATE TABLE `sys_oper_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 604 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_oper_log` VALUES (598, '用户管理', 2, 'com.mars.admin.controller.system.SysUserController.update()', 'PUT', 'admin', '/api/sys/user', '127.0.0.1', '{\"user\":{\"id\":5,\"createTime\":\"2026-01-31 22:30:46\",\"updateTime\":\"2026-02-09 14:30:30\",\"createBy\":5,\"updateBy\":1,\"deleted\":0,\"deptId\":2,\"deptName\":null,\"postNames\":null,\"username\":\"mars666\",\"password\":null,\"nickname\":\"mars666\",\"avatar\":null,\"email\":\"wqexpore@163.com\",\"phone\":\"18888888882\",\"gender\":2,\"status\":1,\"remark\":null,\"userType\":\"admin\",\"openId\":null,\"isQuit\":0},\"roleIds\":[2],\"postIds\":[3,4]}', '{\"code\":200,\"message\":\"操作成功\",\"data\":null}', 0, NULL, '2026-02-24 13:51:43', 53);
INSERT INTO `sys_oper_log` VALUES (599, '用户管理', 2, 'com.mars.admin.controller.system.SysUserController.update()', 'PUT', 'admin', '/api/sys/user', '127.0.0.1', '{\"user\":{\"id\":5,\"createTime\":\"2026-01-31 22:30:46\",\"updateTime\":\"2026-02-09 14:30:30\",\"createBy\":5,\"updateBy\":1,\"deleted\":0,\"deptId\":2,\"deptName\":null,\"postNames\":null,\"username\":\"mars666\",\"password\":null,\"nickname\":\"mars666\",\"avatar\":null,\"email\":\"wqexpore@163.com\",\"phone\":\"18888888882\",\"gender\":1,\"status\":1,\"remark\":null,\"userType\":\"admin\",\"openId\":null,\"isQuit\":0},\"roleIds\":[2],\"postIds\":[3,4]}', '{\"code\":200,\"message\":\"操作成功\",\"data\":null}', 0, NULL, '2026-02-24 13:51:59', 21);
INSERT INTO `sys_oper_log` VALUES (600, '上传文件', 1, 'com.mars.admin.controller.file.SysFileController.upload()', 'POST', 'admin', '/api/sys/file/upload', '127.0.0.1', '', NULL, 1, '文件上传失败', '2026-02-24 14:17:29', 928);
INSERT INTO `sys_oper_log` VALUES (601, '上传文件', 1, 'com.mars.admin.controller.file.SysFileController.upload()', 'POST', 'admin', '/api/sys/file/upload', '127.0.0.1', '', '{\"code\":200,\"message\":\"操作成功\",\"data\":{\"id\":74,\"originalName\":\"FPj0uHDhtvlIgwhfEk0-Lu-bp4Duopj5_GorB8Sxbqe4pKUR4-7HxwbA7VFa8fTK.jpg\",\"fileName\":\"09f3e8016cf94b3ab30bb9457d6a1e9a.jpg\",\"filePath\":\"2026/02/24/09f3e8016cf94b3ab30bb9457d6a1e9a.jpg\",\"url\":\"/api/files/2026/02/24/09f3e8016cf94b3ab30bb9457d6a1e9a.jpg\",\"fileSize\":823196,\"fileType\":\"image/jpeg\",\"fileSuffix\":\".jpg\",\"storageType\":\"local\",\"bucketName\":null,\"groupId\":null,\"createBy\":\"1\",\"createTime\":\"2026-02-24 14:18:04\",\"remark\":null}}', 0, NULL, '2026-02-24 14:18:04', 18);
INSERT INTO `sys_oper_log` VALUES (602, '批量删除文件', 3, 'com.mars.admin.controller.file.SysFileController.deleteBatch()', 'DELETE', 'admin', '/api/sys/file/batch', '127.0.0.1', '[65,64]', '{\"code\":200,\"message\":\"操作成功\",\"data\":null}', 0, NULL, '2026-02-24 14:18:12', 21);
INSERT INTO `sys_oper_log` VALUES (603, '上传文件', 1, 'com.mars.admin.controller.file.SysFileController.upload()', 'POST', 'admin', '/api/sys/file/upload', '127.0.0.1', '', '{\"code\":200,\"message\":\"操作成功\",\"data\":{\"id\":75,\"originalName\":\"caa41ac5c974e4fa96b1df176aeba849.png\",\"fileName\":\"cea0ee440cbd4b22a9385e58c8f0993c.png\",\"filePath\":\"2026/02/24/cea0ee440cbd4b22a9385e58c8f0993c.png\",\"url\":\"/api/files/2026/02/24/cea0ee440cbd4b22a9385e58c8f0993c.png\",\"fileSize\":16286,\"fileType\":\"image/png\",\"fileSuffix\":\".png\",\"storageType\":\"local\",\"bucketName\":null,\"groupId\":null,\"createBy\":\"1\",\"createTime\":\"2026-02-24 14:18:20\",\"remark\":null}}', 0, NULL, '2026-02-24 14:18:21', 10);
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户岗位关联表' ROW_FORMAT = Dynamic;
