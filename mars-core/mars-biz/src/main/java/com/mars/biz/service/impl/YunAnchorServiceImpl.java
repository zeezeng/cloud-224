...
public class YunAnchorServiceImpl extends ServiceImpl<YunAnchorMapper, YunAnchor> implements YunAnchorService {
    ...
    public Page<YunAnchorPageRow> page(Integer page, Integer pageSize, String anchorId, String anchorName,
        ...
        List<YunAnchorPageRow> rows = anchorPage.getRecords().stream().map(anchor -> {
            ...
            row.setTodaySrValue(today == null ? BigDecimal.ZERO : today.getPaidGiftValue());
            row.setTodaySrUserCount(today == null ? null : today.getPaidGiftUserCount());
            row.setTodayLwValue(today == null ? BigDecimal.ZERO : today.getGiftTotalValue());
            row.setTodayLwUserCount(today == null ? null : today.getGiftUserCount());
            row.setTodayStreamHours(today == null ? null : today.getStreamHours());
            row.setYesterdaySrValue(yesterday == null ? BigDecimal.ZERO : yesterday.getPaidGiftValue());
            row.setYesterdaySrUserCount(yesterday == null ? null : yesterday.getPaidGiftUserCount());
            row.setYesterdayLwValue(yesterday == null ? BigDecimal.ZERO : yesterday.getGiftTotalValue());
            row.setYesterdayLwUserCount(yesterday == null ? null : yesterday.getGiftUserCount());
            row.setYesterdayStreamHours(yesterday == null ? null : yesterday.getStreamHours());
            row.setMonthSrValue(month == null ? BigDecimal.ZERO : month.getPaidGiftValue());
            row.setMonthSrUserCount(month == null ? null : month.getPaidGiftUserCount());
            row.setMonthLwValue(month == null ? BigDecimal.ZERO : month.getGiftTotalValue());
            row.setMonthLwUserCount(month == null ? null : month.getGiftUserCount());
            row.setMonthStreamHours(month == null ? null : month.getStreamHours());
