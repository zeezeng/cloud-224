...
public class DingtalkPushService implements PushService {
    ...
    public DingtalkPushService(WebhookSender webhookSender, String signSecret, String webhookUrl) {
        this.webhookSender = webhookSender;
        this.signSecret = signSecret;
        this.webhookUrl = webhookUrl;
        log.info("初始化钉钉推送服务, webhook 已配置={}", StringUtils.hasText(webhookUrl));
    }
